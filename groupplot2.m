...
for fnum=1:nfiles
    ...
    switch XAXIS
        case 'lin'
            cline = plot(fnorm * fd.freq(1:ind-1), dnorm + fd.avgDB(1:ind-1), 'DisplayName', fname);
        case 'log'
            cline = semilogx(fnorm * fd.freq(1:ind-1), dnorm + fd.avgDB(1:ind-1), 'DisplayName', fname);
        otherwise
